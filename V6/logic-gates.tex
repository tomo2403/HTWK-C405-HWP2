...
Im Nachfolgenden finden Sie die Wahrheitswerttabelle für das Abbilden des Zählers auf die
low-active Pins des Würfels.
...
Hier wird die Wahrheitswerttabelle \ref{tab:logicGates-truthtable} in Formeln umgewandelt, welche
dabei direkt grafisch vereinfacht werden.
...
\section{Aufbau}
Die in \ref{fig:logicGates-karnaugMaps} ermittelten Formeln wurden in Gleichungen aus nur NANDs umgewandelt
und anschließend Aufgebaut.
